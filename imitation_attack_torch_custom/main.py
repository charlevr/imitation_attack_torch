...
train_set.to_csv(path_or_buf=r'.\data\train.csv', index=False, quoting=csv.QUOTE_NONE, escapechar='\\')
test_set.to_csv(path_or_buf=r'.\data\test.csv', index=False, quoting=csv.QUOTE_NONE, escapechar='\\')
...
train_dl = BatchWrapper(train_ter, "msg", ["class"])
valid_dl = BatchWrapper(test_iter, "msg", ["class"])
